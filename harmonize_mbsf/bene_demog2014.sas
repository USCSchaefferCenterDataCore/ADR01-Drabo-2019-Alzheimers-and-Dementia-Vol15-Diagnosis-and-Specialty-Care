...
%let maxyr=2014;  /* just in case default maxyr is not already latest year */
...
%let vars0214=bene_dob death_dt v_dod_sw rti_race_cd race sex hmo_mo;
...
data bene.bene_demogall&maxyr;
   ...
   merge clmids (in=_inc)
   			 bsf.bsfab2002 (in=_02 keep=bene_id &vars0214 %den_rename(02,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
   			 bsf.bsfab2003 (in=_03 keep=bene_id &vars0214 %den_rename(03,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
   			 bsf.bsfab2004 (in=_04 keep=bene_id &vars0214 %den_rename(04,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
   			 bsf.bsfab2005 (in=_05 keep=bene_id &vars0214 %den_rename(05,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2006 (in=_06 keep=bene_id &vars0214 %den_rename(06,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2007 (in=_07 keep=bene_id &vars0214 %den_rename(07,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2008 (in=_08 keep=bene_id &vars0214 %den_rename(08,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2009 (in=_09 keep=bene_id &vars0214 %den_rename(09,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2010 (in=_10 keep=bene_id &vars0214  %den_rename(10,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2011 (in=_11 keep=bene_id &vars0214  %den_rename(11,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2012 (in=_12 keep=bene_id &vars0214  %den_rename(12,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2013 (in=_13 keep=bene_id &vars0214  %den_rename(13,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         bene.bsfall2014 (in=_14 keep=bene_id &vars0214 %den_rename(14,bene_dob,death_dt,v_dod_sw,rti_race_cd,race,sex,hmo_mo))
         ;
   by bene_id;
